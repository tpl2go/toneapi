...
namespace tipp
{
    ...
    static inline IppStatus FIRSR(const std::complex<float> *pSrc, std::complex<float> *pDst, int numIters, Ipp8u *pSpec, const std::complex<float> *pDlySrc, std::complex<float> *pDlyDst, Ipp8u *pBuf)
    {
        return OptionalAssertNoError(ippsFIRSR_32fc((Ipp32fc *)pSrc, (Ipp32fc *)pDst, numIters, (IppsFIRSpec_32fc *)pSpec, (Ipp32fc *)pDlySrc, (Ipp32fc *)pDlyDst, pBuf));
    }

    static inline IppStatus FIRSR(const std::complex<double> *pSrc, std::complex<double> *pDst, int numIters, Ipp8u *pSpec, const std::complex<double> *pDlySrc, std::complex<double> *pDlyDst, Ipp8u *pBuf)
    {
        return OptionalAssertNoError(ippsFIRSR_64fc((Ipp64fc *)pSrc, (Ipp64fc *)pDst, numIters, (IppsFIRSpec_64fc *)pSpec, (Ipp64fc *)pDlySrc, (Ipp64fc *)pDlyDst, pBuf));
    }
    ...
    template <>
    static inline IppStatus FIRMRInit<Ipp32f>(const Ipp32f *pTaps, int tapsLen, int upFactor, int upPhase, int downFactor, int downPhase, Ipp8u *pSpec) { return OptionalAssertNoError(ippsFIRMRInit_32f(pTaps, tapsLen, upFactor, upPhase, downFactor, downPhase, (IppsFIRSpec_32f *)pSpec)); }
    template <>
    static inline IppStatus FIRMRInit<Ipp64f>(const Ipp64f *pTaps, int tapsLen, int upFactor, int upPhase, int downFactor, int downPhase, Ipp8u *pSpec) { return OptionalAssertNoError(ippsFIRMRInit_64f(pTaps, tapsLen, upFactor, upPhase, downFactor, downPhase, (IppsFIRSpec_64f *)pSpec)); }
    template <>
    static inline IppStatus FIRMRInit<Ipp32fc>(const Ipp32fc *pTaps, int tapsLen, int upFactor, int upPhase, int downFactor, int downPhase, Ipp8u *pSpec) { return OptionalAssertNoError(ippsFIRMRInit_32fc(pTaps, tapsLen, upFactor, upPhase, downFactor, downPhase, (IppsFIRSpec_32fc *)pSpec)); }
    template <>
    static inline IppStatus FIRMRInit<Ipp64fc>(const Ipp64fc *pTaps, int tapsLen, int upFactor, int upPhase, int downFactor, int downPhase, Ipp8u *pSpec) { return OptionalAssertNoError(ippsFIRMRInit_64fc(pTaps, tapsLen, upFactor, upPhase, downFactor, downPhase, (IppsFIRSpec_64fc *)pSpec)); }
    template <>
    static inline IppStatus FIRMRInit<std::complex<float>>(const std::complex<float> *pTaps, int tapsLen, int upFactor, int upPhase, int downFactor, int downPhase, Ipp8u *pSpec) { return OptionalAssertNoError(ippsFIRMRInit_32fc((Ipp32fc *)pTaps, tapsLen, upFactor, upPhase, downFactor, downPhase, (IppsFIRSpec_32fc *)pSpec)); }
    template <>
    static inline IppStatus FIRMRInit<std::complex<double>>(const std::complex<double> *pTaps, int tapsLen, int upFactor, int upPhase, int downFactor, int downPhase, Ipp8u *pSpec) { return OptionalAssertNoError(ippsFIRMRInit_64fc((Ipp64fc *)pTaps, tapsLen, upFactor, upPhase, downFactor, downPhase, (IppsFIRSpec_64fc *)pSpec)); }
    ...
    template <>
    static inline IppStatus ResamplePolyphaseGetSize<Ipp16s>(Ipp32f window, int nStep, int *pSize, IppHintAlgorithm hint) { return OptionalAssertNoError(ippsResamplePolyphaseGetSize_16s(window, nStep, pSize, hint)); }
    template <>
    ...
    template <>
    static inline IppStatus FIRSparseGetStateSize<Ipp32f>(int nzTapsLen, int order, int *pStateSize) { return OptionalAssertNoError(ippsFIRSparseGetStateSize_32f(nzTapsLen, order, pStateSize)); }
    template <>
    static inline IppStatus FIRSparseGetStateSize<Ipp32fc>(int nzTapsLen, int order, int *pStateSize) { return OptionalAssertNoError(ippsFIRSparseGetStateSize_32fc(nzTapsLen, order, pStateSize)); }
    ...
    template <>
    static inline IppStatus IIRInit<std::complex<float>, std::complex<float>>(void **ppState, const std::complex<float> *pTaps, int order, const std::complex<float> *pDlyLine, Ipp8u *pBuf) { return OptionalAssertNoError(ippsIIRInit_32fc((IppsIIRState_32fc **)ppState, (Ipp32fc *)pTaps, order, (Ipp32fc *)pDlyLine, pBuf)); }
    template <>
    static inline IppStatus IIRInit<std::complex<double>, std::complex<double>>(void **ppState, const std::complex<double> *pTaps, int order, const std::complex<double> *pDlyLine, Ipp8u *pBuf) { return OptionalAssertNoError(ippsIIRInit_64fc((IppsIIRState_64fc **)ppState, (Ipp64fc *)pTaps, order, (Ipp64fc *)pDlyLine, pBuf)); }
    ...
    template <>
    static inline IppStatus IIRGetStateSize<Ipp32f, Ipp16s>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize32f_16s(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64f, Ipp16s>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_16s(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64f, Ipp32s>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_32s(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp32fc, Ipp16sc>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize32fc_16sc(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64fc, Ipp16sc>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64fc_16sc(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64fc, Ipp32sc>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64fc_32sc(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp32f, Ipp32f>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_32f(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64f, Ipp32f>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_32f(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64f, Ipp64f>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_64f(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp32fc, Ipp32fc>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_32fc(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64fc, Ipp32fc>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64fc_32fc(order, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize<Ipp64fc, Ipp64fc>(int order, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_64fc(order, pBufferSize)); }

    // IIRGetStateSize_BiQuad wrappers
    template <typename T1, typename T2>
    static inline IppStatus IIRGetStateSize_BiQuad(int numBq, int *pBufferSize);
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp32f, Ipp16s>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize32f_BiQuad_16s(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64f, Ipp16s>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_BiQuad_16s(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64f, Ipp32s>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_BiQuad_32s(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp32fc, Ipp16sc>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize32fc_BiQuad_16sc(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64fc, Ipp16sc>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64fc_BiQuad_16sc(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64fc, Ipp32sc>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64fc_BiQuad_32sc(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp32f, Ipp32f>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_BiQuad_32f(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64f, Ipp32f>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_BiQuad_32f(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64f, Ipp64f>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_BiQuad_64f(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp32fc, Ipp32fc>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_BiQuad_32fc(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64fc, Ipp32fc>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64fc_BiQuad_32fc(numBq, pBufferSize)); }
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad<Ipp64fc, Ipp64fc>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize_BiQuad_64fc(numBq, pBufferSize)); }

    // IIRGetStateSize_BiQuad_DF1 wrappers
    template <typename T1, typename T2>
    static inline IppStatus IIRGetStateSize_BiQuad_DF1(int numBq, int *pBufferSize);
    template <>
    static inline IppStatus IIRGetStateSize_BiQuad_DF1<Ipp64f, Ipp32s>(int numBq, int *pBufferSize) { return OptionalAssertNoError(ippsIIRGetStateSize64f_BiQuad_DF1_32s(numBq, pBufferSize)); }
    template <>
    ...
    template <>
    static inline IppStatus IIRGetDlyLine<std::complex<float>, std::complex<float>>(const void *pState, std::complex<float> *pDlyLine) { return OptionalAssertNoError(ippsIIRGetDlyLine_32fc((const IppsIIRState_32fc *)pState, (Ipp32fc *)pDlyLine)); }
    template <>
    static inline IppStatus IIRGetDlyLine<std::complex<double>, std::complex<double>>(const void *pState, std::complex<double> *pDlyLine) { return OptionalAssertNoError(ippsIIRGetDlyLine_64fc((const IppsIIRState_64fc *)pState, (Ipp64fc *)pDlyLine)); }
    ...
    template <>
    static inline IppStatus IIRSetDlyLine<std::complex<float>, std::complex<float>>(void *pState, const std::complex<float> *pDlyLine) { return OptionalAssertNoError(ippsIIRSetDlyLine_32fc((IppsIIRState_32fc *)pState, (Ipp32fc *)pDlyLine)); }
    template <>
    static inline IppStatus IIRSetDlyLine<std::complex<double>, std::complex<double>>(void *pState, const std::complex<double> *pDlyLine) { return OptionalAssertNoError(ippsIIRSetDlyLine_64fc((IppsIIRState_64fc *)pState, (Ipp64fc *)pDlyLine)); }
    ...
    template <>
    static inline IppStatus IIR<std::complex<float>, std::complex<float>>(const std::complex<float> *pSrc, std::complex<float> *pDst, int len, void *pState) { return OptionalAssertNoError(ippsIIR_32fc((Ipp32fc *)pSrc, (Ipp32fc *)pDst, len, (IppsIIRState_32fc *)pState)); }
    template <>
    static inline IppStatus IIR<std::complex<double>, std::complex<double>>(const std::complex<double> *pSrc, std::complex<double> *pDst, int len, void *pState) { return OptionalAssertNoError(ippsIIR_64fc((Ipp64fc *)pSrc, (Ipp64fc *)pDst, len, (IppsIIRState_64fc *)pState)); }
    ...
    template <>
    static inline IppStatus IIR_I<std::complex<float>, std::complex<float>>(std::complex<float> *pSrcDst, int len, void *pState) { return OptionalAssertNoError(ippsIIR_32fc_I((Ipp32fc *)pSrcDst, len, (IppsIIRState_32fc *)pState)); }
    template <>
    static inline IppStatus IIR_I<std::complex<double>, std::complex<double>>(std::complex<double> *pSrcDst, int len, void *pState) { return OptionalAssertNoError(ippsIIR_64fc_I((Ipp64fc *)pSrcDst, len, (IppsIIRState_64fc *)pState)); }
