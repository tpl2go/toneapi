...
namespace tipp
{
    ...
    public:
        ...
        void initialise(IppiSizeL roiSize, IppiSizeL maskSize, Ipp8u *pMask)
        {
            IppSizeL specSize;
            IppSizeL bufferSize;
            ippiDilateGetBufferSize_L(roiSize, maskSize, GetIppDataType<T>(), C, &bufferSize);
            DilateGetSpecSize_L(roiSize, maskSize, GetIppDataType<T>(), C, &specSize);
            m_Spec.resize(specSize);
            m_Buffer.resize(bufferSize);
    ...
    public:
        ...
        void initialise(IppiSizeL roiSize, IppiSizeL maskSize, Ipp8u *pMask)
        {
            IppSizeL specSize;
            IppSizeL bufferSize;
            ippiErodeGetBufferSize_L(roiSize, maskSize, GetIppDataType<T>(), C, &bufferSize);
            ippiErodeGetSpecSize_L(roiSize, maskSize, GetIppDataType<T>(), C, &specSize);
            m_Spec.resize(specSize);
            m_Buffer.resize(bufferSize);
    ...
    public:
        ...
        void initialise(IppiSizeL roiSize, IppiSizeL maskSize, Ipp8u *pMask)
        {
            IppSizeL specSize;
            IppSizeL bufferSize;
            ippiMorphGetBufferSize_L(roiSize, maskSize, GetIppDataType<T>(), C, &bufferSize);
            ippiMorphGetSpecSize_L(roiSize, maskSize, GetIppDataType<T>(), C, &specSize);
            m_Spec.resize(specSize);
            m_Buffer.resize(bufferSize);
            ippiMorphInit_L(roiSize, pMask, maskSize, GetIppDataType<T>(), C, (IppiMorphAdvStateL *)m_Spec.data());
            m_roiSize = roiSize;
            m_maskSize = maskSize;
        }
