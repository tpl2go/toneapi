...
namespace tipp {
  namespace cv {
    ...
    public:
      ...
      void apply(const T *pSrc, int srcStep, T *pDst, int dstStep) { Dilate_L<T, C>(pSrc, srcStep, pDst, dstStep, m_roiSize, m_borderType, m_BorderVector[0], (IppiMorphStateL *)m_Spec.data(), m_Buffer.data()); }
    };
    ...
    public:
      ...
      void apply(const T *pSrc, int srcStep, T *pDst, int dstStep) { Erode_L<T, C>(pSrc, srcStep, pDst, dstStep, m_roiSize, m_borderType, m_BorderVector[0], (IppiMorphStateL *)m_Spec.data(), m_Buffer.data()); }
    };
    ...
    public:
      ...
      void Open(const T *pSrc, int srcStep, T *pDst, int dstStep) { MorphOpen_L<T, C>(pSrc, srcStep, pDst, dstStep, m_roiSize, m_borderType, m_BorderVector[0], (IppiMorphAdvStateL *)m_Spec.data(), m_Buffer.data()); }

      void Close(const T *pSrc, int srcStep, T *pDst, int dstStep) { MorphClose_L<T, C>(pSrc, srcStep, pDst, dstStep, m_roiSize, m_borderType, m_BorderVector.data(), (IppiMorphAdvStateL *)m_Spec.data(), m_Buffer.data()); }

      void TopHat(const T *pSrc, int srcStep, T *pDst, int dstStep) { MorphTophat_L<T, C>(pSrc, srcStep, pDst, dstStep, m_roiSize, m_borderType, m_BorderVector.data(), (IppiMorphAdvStateL *)m_Spec.data(), m_Buffer.data()); }

      void BlackHat(const T *pSrc, int srcStep, T *pDst, int dstStep) { MorphBlackhat_L<T, C>(pSrc, srcStep, pDst, dstStep, m_roiSize, m_borderType, m_BorderVector.data(), (IppiMorphAdvStateL *)m_Spec.data(), m_Buffer.data()); }
    };
    ...
    public:
      ...
      void ReconstructErode(const T *pSrc, int srcStep, T *pSrcDst, int srcDstStep, IppiNorm norm) { MorphReconstructErode(pSrc, srcStep, pSrcDst, srcDstStep, m_roiSize, m_Buffer.data(), norm); }

      void ReconstructDilate(const T *pSrc, int srcStep, T *pSrcDst, int srcDstStep, IppiNorm norm) { MorphReconstructDilate(pSrc, srcStep, pSrcDst, srcDstStep, m_roiSize, m_Buffer.data(), norm); }
    };
  } // namespace cv
} // namespace tipp
