...
namespace tipp {
  namespace s {
    ...
    template <typename T>
    static inline IppStatus SortRadixGetBufferSize(int len, int *pBuffferSize) {
      throw std::runtime_error("Unsupported data type for SortRadixGetBufferSize");
    };
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp8u>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp8u, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp16u>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp16u, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp32u>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp32u, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp64u>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp64u, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp16s>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp16s, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp32s>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp32s, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp64s>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp64s, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp32f>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp32f, pBuffferSize));
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize<Ipp64f>(int len, int *pBuffferSize) {
      return OptionalAssertNoError(ippsSortRadixGetBufferSize(len, IppDataType::ipp64f, pBuffferSize));
    }
    ...
    template <typename T>
    static inline IppStatus SortRadixGetBufferSize_L(int len, long long *pBuffferSize) {
      throw std::runtime_error("SortRadixGetBufferSize_L not implemented for this type");
    };

    template <>
    static inline IppStatus SortRadixGetBufferSize_L<Ipp64u>(int len, long long *pBuffferSize) {
      ippsSortRadixGetBufferSize_L(len, IppDataType::ipp64u, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize_L<Ipp32s>(int len, long long *pBuffferSize) {
      ippsSortRadixGetBufferSize_L(len, IppDataType::ipp32s, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize_L<Ipp64s>(int len, long long *pBuffferSize) {
      ippsSortRadixGetBufferSize_L(len, IppDataType::ipp64s, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize_L<Ipp32f>(int len, long long *pBuffferSize) {
      ippsSortRadixGetBufferSize_L(len, IppDataType::ipp32f, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixGetBufferSize_L<Ipp64f>(int len, long long *pBuffferSize) {
      ippsSortRadixGetBufferSize_L(len, IppDataType::ipp64f, pBuffferSize);
    }
    ...
    template <typename T>
    static inline IppStatus SortRadixIndexGetBufferSize(int len, int *pBuffferSize) {
      throw std::runtime_error("SortRadixIndexGetBufferSize not implemented for this type");
    };
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp8u>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp8u, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp16u>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp16u, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp32u>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp32u, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp64u>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp64u, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp16s>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp16s, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp32s>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp32s, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp64s>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp64s, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp32f>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp32f, pBuffferSize);
    }
    template <>
    static inline IppStatus SortRadixIndexGetBufferSize<Ipp64f>(int len, int *pBuffferSize) {
      ippsSortRadixIndexGetBufferSize(len, IppDataType::ipp64f, pBuffferSize);
    }
